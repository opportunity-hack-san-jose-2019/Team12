...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { event_id: @interview.event_id, interviewer_id: @interview.interviewer_id, student_id: @interview.student_id } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { event_id: @interview.event_id, interviewer_id: @interview.interviewer_id, student_id: @interview.student_id } }
